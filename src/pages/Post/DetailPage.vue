          ...
          <div class="ass1-comments">
            ...
            <div class="ass1-comments__section">
              ...
              <div class="ass1-comments__content">
                ...
                <p>Scratch off globe, for when you want to wipe out any country that displeases you but lack the
                  weaponry to do so.</p>
            ...
            <div class="ass1-comments__section">
              ...
              <div class="ass1-comments__content">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Distinctio dolores officiis, ducimus
                  veritatis voluptatibus alias quos, magnam sed non quo hic mollitia perferendis nostrum? Commodi
                  reprehenderit nesciunt saepe, libero et.</p>
                <div class="ass1-comments__info">
                  <a href="#" class="ass1-comments__btn-upvote ass1-btn-icon"><i
                      class="icon-Upvote"></i><span>901</span></a>
                  <a href="#" class="ass1-comments__btn-down ass1-btn-icon"><i
                ...
                <div class="ass1-comments__section">
                  ...
                  <div class="ass1-comments__content">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Enim debitis cumque nostrum blanditiis
                      iusto amet illo necessitatibus, ea quibusdam quidem quod, doloribus, voluptatem est saepe nulla ex
                      optio ut quas.</p>
                    <div class="ass1-comments__info">
                      <a href="#" class="ass1-comments__btn-upvote ass1-btn-icon"><i
                          class="icon-Upvote"></i><span>901</span></a>
                ...
                <div class="ass1-comments__section">
                  ...
                  <div class="ass1-comments__content">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Neque voluptatibus distinctio possimus
                      qui, incidunt illum nesciunt ad! Cum hic pariatur, velit, dignissimos ratione necessitatibus natus
                      neque sed esse, voluptatum ipsum.</p>
                    <div class="ass1-comments__info">
                      <a href="#" class="ass1-comments__btn-upvote ass1-btn-icon"><i
                          class="icon-Upvote"></i><span>256</span></a>
                      <a href="#" class="ass1-comments__btn-down ass1-btn-icon"><i
                          class="icon-Downvote"></i><span>12</span></a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="ass1-comments__section">
              ...
              <div class="ass1-comments__content">
                ...
                <div class="ass1-comments__info">
                  <a href="#" class="ass1-comments__btn-upvote ass1-btn-icon"><i
                      class="icon-Upvote"></i><span>543</span></a>
                  <a href="#" class="ass1-comments__btn-down ass1-btn-icon"><i
                      class="icon-Downvote"></i><span>21</span></a>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="col-lg-4">
        <aside class="ass1-aside">
          ...
          <div class="ass1-section">
            ...
            <div class="ass1-section__content">
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsum tempore recusandae, nemo consequuntur
                rem pariatur ducimus dolorem aperiam nesciunt dolore, ratione aut, corporis laborum? Numquam ad magnam
                consectetur labore quam?</p>
            </div>
            <div class="ass1-section__footer">
              <a href="#" class="ass1-section__btn-upvote ass1-btn-icon"><i class="icon-Upvote"></i></a>
              <a href="#" class="ass1-section__btn-downvote ass1-btn-icon"><i class="icon-Downvote"></i></a>
